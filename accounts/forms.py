...
class UserUpdateForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_account ,created = UserBankAccount.objects.get_or_create(user=user) #jodi account thake taile seta jabe get account e and jodi user na thake taile seta jabe create account e
